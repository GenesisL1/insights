...
The counters package at block 13,412,747 reports the collection state. A separately pre-committed randomized sample of 100 parent records at block 13,436,937 was drawn from an enumerated parent-ID set using a future block hash; 0 reconstructed successfully and 0 passed the declared canonical atom, chain/entity and coordinate-fidelity checks. Every draw and failure remains published.
