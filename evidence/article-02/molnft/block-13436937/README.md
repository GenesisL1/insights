...
| Canonical structural-fidelity passes | **99** |
| Final failures | **1** |
| Exact normalized coordinate-hash matches | **98** |
| Coordinate tolerance | **1e-06 Å** |

Final failure accounting: **1 FIDELITY_MISMATCH**.
...
python tools/evidence/finalize_molnft_structural_evidence.py   --evidence evidence/article-02/molnft/block-13436937   --verify-deterministic
```
