...
def render_insights_index(facts: dict[str, Any], title: str, description: str, press_title: str, press_description: str) -> None:
    ...
    text = re.sub(
        r'<article class="article-card" id="article-scientific-renaissance">.*?</article>\s*<article class="article-card" id="press-release-current">.*?</article>',
